...
namespace Paint111
{
    public partial class Form1 : Form
    {
        ...
        private void pictureBox1_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            if (tool == Tool.ERASER)
            {
                gBitmap.FillRectangle(new Pen(Color.White).Brush, GetRectangle(prevPoint, curPoint));
            }
        }
        ...
        private void pictureBox1_Paint(object sender, PaintEventArgs e)
        {
            ...
            if(tool == Tool.ERASER)
            {
                e.Graphics.DrawRectangle(new Pen(Color.Black), GetRectangle(prevPoint, curPoint));
            }
        }
